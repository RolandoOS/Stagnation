...
plt.savefig(PATH_RES+'scatter_matrix_2.png', dpi = 200);
plt.show()
plt.clf()
...
print "Training time (sec):", time()-begin

print "Regression score:", rfr.score(test[factors], test['AmmSO4']) # 0.53
...
plt.savefig(PATH_RES+'random_forest_met_1.png', dpi = 200);
plt.show()

test['2005'][['AmmSO4','wnd_2m','temp_2m']].resample('d', how='mean').plot()
plt.savefig(PATH_RES+'random_forest_met_2.png', dpi = 200);
plt.show()
...
print "Training time (sec):", time()-begin, "for", N, "trees."
